...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ url('/') }}" target="_blank" class="brand-link">
            <img src="../../../assets/admin/img/AdminLTELogo.png" alt="AdminLTE Logo"
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="../../../assets/admin/img/user2-160x160.jpg" class="img-circle elevation-2"
                         alt="User Image">
                </div>
                <div class="info">
...
<!-- /.content-wrapper -->
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; {{ date('Y') }} </strong> Created by Parusov.
    </footer>
